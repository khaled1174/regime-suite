...
with st.sidebar:
    ...
    <b style='color:#3fb950'>Green</b> = bull · <b style='color:#f85149'>Red</b> = bear · <b style='color:#8b949e'>Gray</b> = transitional
    </div>
...
if not run_btn:
    ...
    <div style='text-align:center;padding:40px 0;color:#8b949e'>
      <p style='font-size:.95rem;margin:0'>Configure and click <b style="color:#3fb950">Run HMM Analysis</b></p>
    </div>
    """, unsafe_allow_html=True)
    st.stop()
...
with st.expander("🔬 HMM Model Details"):
    ...
    st.dataframe(tm_df.style.format("{:.3f}"), width="stretch")
